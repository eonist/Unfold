...
class UnfoldUtils {//Fixme: ⚠️️ Rename to UnfoldUtil.
    /**
     * String
     * ⚠️️ add throws
     */
    static func value(_ dict: [String: Any], key: String) -> String? {// ⚠️️
     ...
     * ⚠️️ add throws
     */
    static func value(_ dict: [String: Any], key: String) -> CGFloat {// ⚠️️
        if let value: Any = dict[(key)] {
