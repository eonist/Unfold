...
class UnfoldParser{
     ...
     * TODO: ⚠️️ A problem with this method is that it doesn't keep searching similar named parents. So if you have 2 parents with the same id, it only traverses the first
     */
    static func unfoldable(parent:UnFoldable, path:[String]) throws -> UnFoldable{//TODO: ⚠️️ rename to paths?
     ...
     */
    static func unfoldable<T>(parent:UnFoldable, path:[String]) throws -> T {//TODO: ⚠️️ rename to paths?
     ...
     */
    static func value<T>(_ view:UnFoldable,  path:[String]) throws -> T {//TODO: ⚠️️ rename to paths?
